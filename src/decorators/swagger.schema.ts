/* eslint-disable max-len,@typescript-eslint/ban-types,@typescript-eslint/no-unsafe-argument,import/no-duplicates,@typescript-eslint/no-unsafe-enum-comparison */
